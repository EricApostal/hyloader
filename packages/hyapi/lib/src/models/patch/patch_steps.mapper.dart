...
class PatchStepMapper extends ClassMapperBase<PatchStep> {
  ...
  static Uri _$pwr(PatchStep v) => v.pwr;
  static const Field<PatchStep, Uri> _f$pwr = Field('pwr', _$pwr);
  static Uri _$sig(PatchStep v) => v.sig;
  static const Field<PatchStep, Uri> _f$sig = Field('sig', _$sig);
...
abstract class PatchStepCopyWith<$R, $In extends PatchStep, $Out>
  ...
  $R call({int? from, Uri? pwr, Uri? sig, int? to});
...
class _PatchStepCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({int? from, Uri? pwr, Uri? sig, int? to}) => $apply(
    FieldCopyWithData({
